    ...
    <div className="relative">
      ...
      {isModalOpen && selectedUser && (
        <div className="fixed inset-0 flex justify-center items-center z-50">
          ...
          {/* modal content */}
          <div className="relative z-10 bg-white p-6 rounded-lg w-full sm:w-1/2 shadow-lg">
            ...
            <div className="mt-4 flex flex-wrap gap-4">
              ...
              >
                {selectedUser.status !== "blocked" ? "Block" : "Unblock"}
              </button>
              ...
              <button
                ...
                onClick={() => handleRoleChange(selectedUser._id, "donor")}
              >
                Make Donor
              </button>
              <button
